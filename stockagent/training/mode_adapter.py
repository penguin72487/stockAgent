...
_MODE_SPECS: Final[tuple[TrainingModeSpec, ...]] = (
    ...
    TrainingModeSpec(
        ...
        product_family="taifex_standard_and_mini_single_stock_futures_with_full_stock_context",
        frequency="daily_decision_scheduled_minute_execution",
        decision_clock="0845_prior_completed_cash_stock_features_no_current_cash_open",
        execution_clock="0846_entry_1320_limit_1324_market_1330_terminal",
        recurrent_state_scope="integer_intraday_positions_and_cross_day_equity",
        terminal_policy="flat_by_1330_or_absorbing_execution_failure",
        split_ownership="year_expanding_walk_forward",
        benchmark_contract="equal_weight_observed_futures_0846_to_1330",
        weight_snapshot_contract="actual_entry_notional_over_opening_equity",
        turnover_contract="actual_entry_and_exit_notional_over_opening_equity",
    ),
    TrainingModeSpec(
