    ...
    *,
    ...
    if model_name in _TRANSFORMER_BASE_PORTFOLIO_NAMES:
        ...
        return TransformerBasePortfolioModel(
            ...
            portfolio_gross_gate_min=tbp_cfg.portfolio_gross_gate_min,
            portfolio_gross_gate_max=tbp_cfg.portfolio_gross_gate_max,
            portfolio_gross_gate_init=tbp_cfg.portfolio_gross_gate_init,
            portfolio_net_gate_max=tbp_cfg.portfolio_net_gate_max,
            portfolio_net_gate_init=tbp_cfg.portfolio_net_gate_init,
