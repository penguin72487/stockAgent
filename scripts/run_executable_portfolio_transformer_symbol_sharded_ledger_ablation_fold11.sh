...
SPEC="configs/ablations/executable_portfolio_transformer_symbol_sharded_ledger_fold11_v1.yaml"
OUTPUT_ROOT="artifacts/ablations/executable_portfolio_transformer_symbol_sharded_ledger_fold11_v1"
EPOCHS="${STOCKAGENT_LEDGER_ABLATION_EPOCHS:-3}"
SEED="${STOCKAGENT_LEDGER_ABLATION_SEED:-42}"
...
EXPERIMENTS=(
  baseline
  replicated_ledger
  unpacked_metadata_collectives
  unpacked_scalar_collectives
  keep_noop_collectives
  eager_model
  eager_ledger
  batch64
)
