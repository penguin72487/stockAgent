...
def test_schema10_prior_backtest_contract_cannot_resume_but_can_infer(
    tmp_path: Path,
) -> None:
    ...
    prior_contract["contracts"]["trading"]["canonical_backtest_contract_version"] = 10
    ...
    with pytest.raises(RuntimeError, match="trading"):
        _validate_checkpoint_manifest(
            checkpoint,
            expected,
            checkpoint_path=tmp_path / "prior_backtest_schema10.pt",
            scope="resume",
        )
